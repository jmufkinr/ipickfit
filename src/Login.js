              ...
              <div className="mx-auto text-center">
                ...
                <form className="col-md-6 ">
                  ...
                  <div className="form-group">
                    <label
                      id="emailLabel"      htmlFor="email">Email address:</label>
                    <input 
                      type="email" 
                      name="email"
                      ...
                      ref="email"
                      id="email" placeholder="Email" onChange={this.submitHandler}
                    required />
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      ref="password"
                      id="password" 
                      value={this.state.password} placeholder="minimum 6 Caracters" 
                  ...
                  <div className="btnContainer">
                    <p>
                      <button 
                        ...
                        onClick={this.onSubmitButtonClick}> Login  
                      </button>
